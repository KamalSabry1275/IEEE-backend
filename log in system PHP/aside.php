                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li>
                                    <form action="includes/productShow.inc.php" method="post">
                                        <input type="submit" name="show_products" value="Show Products"
                                            style="background: transparent; border-width:0;padding:10px 10px;cursor:pointer;">
                                    </form>
                                    <form action="productAdd.php?username=<?php echo $_COOKIE["data"]["username"]?>"
                                        method="post">
            ...
            <header id="header" class="header">
                <div class="top-left">
                    <div class="navbar-header">
                        <a class="navbar-brand" href=""><img src="logo/lets-shopping-logo-design.jpg" alt="Logo"
                                height="50px"></a>
                    ...
                    <div class="header-menu">
                        ...
                        <div class="user-area dropdown float-right">
                            <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <img class="user-avatar rounded-circle" src="favicon_io/favicon-16x16.png"
                                    alt="User Avatar">
                            </a>
